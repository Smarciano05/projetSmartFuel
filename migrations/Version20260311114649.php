...
final class Version20260311114649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pompiste (id INT AUTO_INCREMENT NOT NULL, nom_pompiste VARCHAR(255) NOT NULL, prenom_pompiste VARCHAR(255) NOT NULL, IDStation INT NOT NULL, INDEX IDX_9F26C91BF40773B6 (IDStation), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE pompiste ADD CONSTRAINT FK_9F26C91BF40773B6 FOREIGN KEY (IDStation) REFERENCES stations (id)');
    }
